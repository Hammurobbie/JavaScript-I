...
const parent = {
  name: "Susan",
  age: 70,
  speak: function() { return "Hi there, I\'m " + this.name + "!"},
  child: {
    name: "George",
    age: 50,
    ...
    grandchild: {
      name: "Sam",
      age: 30,
      speak: function() { return "Assuhdude, I\'m " + this.name + "."},
    }
  }
};
...
console.log(parent.child.grandchild.name), console.log(parent.child.grandchild.age);
